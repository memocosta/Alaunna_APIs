...
module.exports = {
    ...
    ***************************************************************************/
    default: {
      ...
      ****************************************************************************/
      // ssl: true,
      user: 'alaunna_dev',
      password: 'ramysoft.com',
      database: 'alaunna_dev',
      dialect: 'mysql',
      options: {
        dialect: 'mysql',
        host: 'localhost',
        port: 3306,
        encrypt: true,
        logging: null     // or specify sa ils log level to use ('info', 'warn', 'verbose', tc)
      },
    },
  },
  ...
  security: {
    ...
    ***************************************************************************/
    cors: {
      ...
      /*allowOrigins: [
        'https://example.com',
        'https://awshn.azurewebsites.net',
        'http://localhost:4200',
        'https://alaunna.com',
        'https://www.alaunna.com',
        'http://www.alaunna.com',
        'http://localhost:4000',
        'http://universal.alaunna.com',
        'http://garcoon.alaunna.com',
        'https://garcoon.alaunna.com',
        'https://universal.alaunna.com',
        'http://localhost'
      ]*/
    },
  ...
  **************************************************************************/
  ...
  //   cert: require('fs').readFileSync(require('path').resolve(__dirname + '/ssl/certificate.pem')).toString()
  // },

  ssl: {
    ca: require('fs').readFileSync(require('path').resolve(__dirname,'../ssl/my-gd-bundle.crt')),
    key: require('fs').readFileSync(require('path').resolve(__dirname,'../ssl/key.key')),
