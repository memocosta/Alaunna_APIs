...
module.exports = {
  index: async function (req, res) {
    try {
      ...
      var SelectedAdd = await SellerAddress.findAndCountAll(fitlerObj);
  ...
  create: async function (req, res) {
    try {
      ...
      let CreatedCoupon = await SellerAddress.create(params);
  ...
  update: async function (req, res) {
    try {
      ...
      let SelectedAddress = await SellerAddress.findOne({
        where: {
          id: params.id
        }
      });
  ...
  remove: async function (req, res) {
    try {
      ...
      var SelectedAddress = await SellerAddress.findOne({
        where: {
          id: address_id
        }
      });
